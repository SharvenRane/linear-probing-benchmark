"""
Linear Probing Benchmark - Model Architecture
"""
import torch
...
class LinearProbingBenchmark(nn.Module):
    """
    Main model for linear probing benchmark.
    """
...
def build_model(config):
    model = LinearProbingBenchmark(config)
