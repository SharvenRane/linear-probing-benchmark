"""
Linear Probing Benchmark - Dataset
"""
import os
import torch
...
class LinearProbingBenchmarkDataset(Dataset):
    """Dataset for linear probing benchmark."""
...
def get_dataloader(root, split, config):
    ...
    dataset = LinearProbingBenchmarkDataset(root, split, transform)
    return DataLoader(
        dataset,
